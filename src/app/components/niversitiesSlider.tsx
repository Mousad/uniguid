      ...
      {universities.map((uni) => (
        <SwiperSlide key={uni.id}>
          ...
          <Link to={`/universities/${uni.id}`}>
            ...
            <div className="bg-[#fefcfd] rounded-[2px] shadow-md overflow-hidden flex flex-col items-center hover:shadow-xl transition">

              <div className="relative w-full">
                <img
                  src={uni.image}
                  alt={uni.name}
                  className="w-full h-56 object-cover rounded-t-[10px]"
                />
