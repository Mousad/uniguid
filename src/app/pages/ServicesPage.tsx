...
const servicesCards = [
  {
    ...
    desc: "نساعدك في التقديم على أفضل المنح الدراسية.",
    image: "https://res.cloudinary.com/drxozhuee/image/upload/v1759688373/VNU_M728_12_d1dhkm.png",
    icon: GraduationCap,
  ...
  },
  {
    ...
    desc: "استشارة مجانية لاختيار أفضل جامعة وتخصص.",
    image: "https://res.cloudinary.com/drxozhuee/image/upload/v1759688351/01_Consulting_the_Expert_Insurance_Agency_nqfmm2.png",
    icon: MessageCircle,
  ...
  },
   {
    ...
    desc: "كورسات تؤهلك للدراسة وسوق العمل.",
    image: "https://res.cloudinary.com/drxozhuee/image/upload/v1759688395/schlbuildingart-01_qefjll.png",
    icon: BookOpen,
  ...
  },
  {
    ...
    desc: "استخراج جميع أنواع الشهادات التعليمية.",
    image: "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=800",
    icon: FileText,
    color: "from-orange-500 to-yellow-500",
    bg: "from-orange-50 to-yellow-50",
    border: "border-orange-100",
    link: "/services/certificate-services",
  },
  {
    title: "الكورسات",
    desc: "كورسات تؤهلك للدراسة وسوق العمل.",
...
export function ServicesPage() {
  ...
  <div className="container mx-auto px-4">
    ...
    <div className="text-center mb-16">
      <span className="inline-block px-4 py-2 rounded-full bg-[#0d2b5e]/10 text-[#0d2b5e] font-semibold mb-5">
        خدماتنا
      </span>

      <h2 className="text-4xl md:text-5xl font-bold text-[#0d2b5e] mb-5">
      ...
      {servicesCards.map((service, index) => {
        ...
        return (
          <Link
            key={index}
            to={service.link}
            className={`group relative bg-white border-2 ${service.border}
            rounded-3xl overflow-hidden transition-all duration-500
            hover:-translate-y-3 hover:shadow-2xl`}
          >

            {/* الخلفية */}
            <div className="absolute top-0 right-0 w-44 h-44 rounded-full blur-3xl bg-[#0d2b5e]/5 group-hover:scale-150 transition duration-700"></div>

            {/* الصورة */}
            <div
              className={`relative p-8 bg-gradient-to-br ${service.bg}`}
            >
              <img
                src={service.image}
                alt={service.title}
              ...
              {/* الأيقونة */}
              <div
                className={`absolute top-6 right-6 w-14 h-14 rounded-2xl bg-gradient-to-r ${service.color}
                flex items-center justify-center text-white shadow-xl
                group-hover:rotate-12 group-hover:scale-110 transition`}
              >
                <Icon size={28} />
              </div>
            </div>
            ...
            <div className="p-8">
              ...
              <div className="flex items-center gap-2 font-bold text-[#0d2b5e] group-hover:gap-4 transition-all">
            ...
            <div
              ...
              scale-x-0 group-hover:scale-x-100 origin-left transition duration-500`}
            ></div>
